class JoysController < ApplicationController
  ...
  private
    ...
    def joy_params
      params.require(:joy).permit(:name, :emotion_name, :title, :size_mb, :records, :file, :formula, :chemistry, :legal_status, :clinical_data, :cas_number, :states, :attitudes, :affection, :drug,  :side_effects, :causes, :psychology, :theroy, :feeling)
    end
end
