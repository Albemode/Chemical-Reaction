class PainsController < ApplicationController
  ...
  private
    ...
    def pain_params
      params.require(:pain).permit(:name, :emotion_name, :title, :size_mb, :records, :file, :formula, :chemistry, :legal_status, :clinical_data, :cas_number, :states, :attitudes, :affection, :drug, :side_effects, :causes, :psychology, :nociceptive, :psychogenic, :theroy, :assessment)
    end
end
