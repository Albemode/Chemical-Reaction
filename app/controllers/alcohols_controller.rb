class AlcoholsController < ApplicationController
  ...
  private
    ...
    def alcohol_params
      params.require(:alcohol).permit(:name, :drug_name, :title, :size_mb, :records, :file, :formula, :chemistry, :legal_status, :clinical_data, :cas_number, :side_effects, drug: [:drug_id])
    end
end
